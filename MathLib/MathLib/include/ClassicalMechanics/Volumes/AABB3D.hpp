...
namespace ClassicalMechanics
{
	namespace Volumes
	{
		...
		void ClassicalMechanics::Volumes::AABB3D_tpl< ScalarType >::CheckBounds( void )
		{
			...
			{
				tmp = m_Maximum.Z;
				m_Maximum = m_Minimum.Z;
				m_Minimum.Z = tmp;
			}
		}

		template< typename ScalarType >
		const LinearMath::Vector3_tpl< ScalarType > ClassicalMechanics::Volumes::AABB3D_tpl< ScalarType >::Size( void ) const
		{
